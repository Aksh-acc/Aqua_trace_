...
"[project]/coral_bleach_detector/orchids-coral-reef-ai-intelligence-main/.next-internal/server/app/api/agent-chat/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/coral_bleach_detector/orchids-coral-reef-ai-intelligence-main/src/app/api/agent-chat/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchSSTData(latitude, longitude) {
    try {
...
function getImageAnalysisPrompt(sstData) {
    ...
    try {
        ...
        if (history && Array.isArray(history) && history.length > 0) {
            ...
            conversationHistory.push({
                ...
                parts: [
                    {
                        text: "I understand. I'm CoralSense Guardian, ready to help with coral reef monitoring and conservation. I'll remember our conversation context."
                    }
                ]
            });
        ...
        if (image) {
            ...
            const imagePrompt = sstData ? getImageAnalysisPrompt(sstData) : getImageAnalysisPrompt({
                sst_celsius: 28,
                dhw: 2,
                anomaly: 0.5,
                status: "Unknown",
            ...
            try {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$coral_bleach_detector$2f$orchids$2d$coral$2d$reef$2d$ai$2d$intelligence$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    metrics: {
                        ...
                        riskLevel: sstData?.dhw >= 8 ? "Critical" : sstData?.dhw >= 4 ? "High" : sstData?.dhw >= 1 ? "Moderate" : "Low"
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92f978c9._.js.map